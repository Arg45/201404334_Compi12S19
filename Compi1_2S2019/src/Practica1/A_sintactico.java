...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sat Aug 10 17:50:17 CST 2019
  */
public class A_sintactico extends java_cup.runtime.lr_parser {
  ...
  public int error_sym() {return 1;}
    ...
    public static void setSalidaHTML(String entrada){
        HTML = entrada;
System.out.println("si imprime esto es porque llego al setSalida");
        /* for(int i=0; i<listaHTML.size(); i++){
            System.out.println(listaHTML.get(i));
        } */
    }
    ...
    public void syntax_error(Symbol s)
    {
        ...
        ErrorSintactico datos = new ErrorSintactico(fila,columna,lexema,"Caracter no esperado");
        ListaErroresSintacticos.add(datos);
    }
